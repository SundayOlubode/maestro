...
exports.SYSTEM_CONTENT = `With a given word, you are to generate the meaning of that word, along with ${exports.NODE_ENV === 'production' ? 'forty' : 'ten'} numbered usages of that word in sentences.`;
exports.IDIOM_SYSTEM_CONTENT = `You are a vocabulary assistant that helps users understand idioms. With a given idiom, you are to generate the meaning of that idiom, along with ${exports.NODE_ENV === 'production' ? 'forty' : 'ten'} numbered usages of that idiom in sentences.`;
